...
from packages.fetchai.protocols.default import default_pb2  # type: ignore
from packages.fetchai.protocols.default.custom_types import ErrorCode  # type: ignore

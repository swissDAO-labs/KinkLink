...
"""
This module contains the support resources for the kink_sync protocol.
...
from packages.zarathustra.protocols.kink_sync.serialization import KinkSyncSerializer


KinkSyncMessage.serializer = KinkSyncSerializer
